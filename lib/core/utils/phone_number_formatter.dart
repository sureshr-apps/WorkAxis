...
abstract final class PhoneNumberFormatter {
  /// Normalizes a national number and dial code to E.164 standard format (e.g., +15551234567).
  static String toE164(
      {required String countryCode, required String nationalNumber}) {
  ...
  /// Masks a phone number for sensitive display (e.g. "+1 (***) ***-4567" or "+1 555***4567").
