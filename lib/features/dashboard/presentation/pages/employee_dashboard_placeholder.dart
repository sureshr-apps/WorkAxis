...
class EmployeeDashboardPlaceholder extends StatelessWidget {
  const EmployeeDashboardPlaceholder({super.key});
        ...
        title: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  activeMembership?.organization.name ?? 'Employee Portal',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Assigned to ${activeMembership?.branchName ?? "Main Branch"} at ${activeMembership?.organization.name ?? "Organization"}.',
